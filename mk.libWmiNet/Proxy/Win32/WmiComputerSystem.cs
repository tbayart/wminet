...
namespace mk.libWmiNet.Classes.Win32
{
    ...
    //   MgmtClassGen.exe  Win32_ComputerSystem  /L CS  /O Wmi.CIMv2.Win32  /N root\cimv2  /P WmiComputerSystem.cs
    //
    ...
    //
    public class WmiComputerSystem : System.ComponentModel.Component
    {
        ...
        public WmiComputerSystem(string keyName)
        {
            this.InitializeObject(null, new System.Management.ManagementPath(WmiComputerSystem.ConstructPath(keyName)), null);
        }

        public WmiComputerSystem(System.Management.ManagementScope mgmtScope, string keyName)
        {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(WmiComputerSystem.ConstructPath(keyName)), null);
        }

        public WmiComputerSystem(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(null, path, getOptions);
        }

        public WmiComputerSystem(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path)
        {
            this.InitializeObject(mgmtScope, path, null);
        }

        public WmiComputerSystem(System.Management.ManagementPath path)
        {
            this.InitializeObject(null, path, null);
        }

        public WmiComputerSystem(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(mgmtScope, path, getOptions);
        }

        public WmiComputerSystem(System.Management.ManagementObject theObject)
        {
            Initialize();
        ...
        public WmiComputerSystem(System.Management.ManagementBaseObject theObject)
        {
            Initialize();
            if ((CheckIfProperClass(theObject) == true))
            {
...
Note:  The SE_SYSTEM_ENVIRONMENT privilege is required on IA64bit machines. This privilege is not required for 32bit systems.")]
        ...
        [Browsable(true)]
        public static WmiComputerSystem CreateInstance()
        {
            ...
            return new WmiComputerSystem(tmpMgmtClass.CreateInstance());
        }
        ...
        public class ComputerSystemCollection : object, ICollection
        {
            ...
            public virtual void CopyTo(System.Array array, int index)
            {
                ...
                {
                    array.SetValue(new WmiComputerSystem(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class ComputerSystemEnumerator : object, System.Collections.IEnumerator
            {
                ...
                public virtual object Current
                {
                    get
                    {
                        return new WmiComputerSystem(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
