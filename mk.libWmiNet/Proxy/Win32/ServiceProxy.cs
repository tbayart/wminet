...
namespace mk.libWmiNet.Proxy.Win32
{
    // This class was autogenerated using the following command:
    //   MgmtClassGen.exe  Win32_Service  /L CS  /O mk.libWmiNet.Proxy.Win32  /N root\cimv2  /P ServiceProxy.cs
    //
    ...
    public class ServiceProxy : System.ComponentModel.Component
    {
        ...
        public ServiceProxy(string keyName)
        {
            this.InitializeObject(null, new System.Management.ManagementPath(ServiceProxy.ConstructPath(keyName)), null);
        }

        public ServiceProxy(System.Management.ManagementScope mgmtScope, string keyName)
        {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(ServiceProxy.ConstructPath(keyName)), null);
        }

        public ServiceProxy(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(null, path, getOptions);
        }

        public ServiceProxy(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path)
        {
            this.InitializeObject(mgmtScope, path, null);
        }

        public ServiceProxy(System.Management.ManagementPath path)
        {
            this.InitializeObject(null, path, null);
        }

        public ServiceProxy(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(mgmtScope, path, getOptions);
        }

        public ServiceProxy(System.Management.ManagementObject theObject)
        {
            Initialize();
        ...
        public ServiceProxy(System.Management.ManagementBaseObject theObject)
        {
            Initialize();
            if ((CheckIfProperClass(theObject) == true))
            {
...
Example: DWDOM\Admin.")]
        ...
        [Browsable(true)]
        public static ServiceProxy CreateInstance()
        {
            ...
            return new ServiceProxy(tmpMgmtClass.CreateInstance());
        }
        ...
        public class ServiceCollection : object, ICollection
        {
            ...
            public virtual void CopyTo(System.Array array, int index)
            {
                ...
                {
                    array.SetValue(new ServiceProxy(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class ServiceEnumerator : object, System.Collections.IEnumerator
            {
                ...
                public virtual object Current
                {
                    get
                    {
                        return new ServiceProxy(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
