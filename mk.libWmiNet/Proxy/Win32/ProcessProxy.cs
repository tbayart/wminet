...
namespace mk.libWmiNet.Proxy.Win32
{
    ...
    //   MgmtClassGen.exe  Win32_Process  /L CS  /O Wmi.CIMv2.Win32  /N root\cimv2  /P WmiProcess.cs
    //
    ...
    public class ProcessProxy : System.ComponentModel.Component
    {
        ...
        public ProcessProxy(string keyHandle)
        {
            this.InitializeObject(null, new System.Management.ManagementPath(ProcessProxy.ConstructPath(keyHandle)), null);
        }

        public ProcessProxy(System.Management.ManagementScope mgmtScope, string keyHandle)
        {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(ProcessProxy.ConstructPath(keyHandle)), null);
        }

        public ProcessProxy(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(null, path, getOptions);
        }

        public ProcessProxy(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path)
        {
            this.InitializeObject(mgmtScope, path, null);
        }

        public ProcessProxy(System.Management.ManagementPath path)
        {
            this.InitializeObject(null, path, null);
        }

        public ProcessProxy(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(mgmtScope, path, getOptions);
        }

        public ProcessProxy(System.Management.ManagementObject theObject)
        {
            Initialize();
        ...
        public ProcessProxy(System.Management.ManagementBaseObject theObject)
        {
            Initialize();
            if ((CheckIfProperClass(theObject) == true))
            {
...
Example: 20480.")]
        ...
        [Browsable(true)]
        public static ProcessProxy CreateInstance()
        {
            ...
            return new ProcessProxy(tmpMgmtClass.CreateInstance());
        }
        ...
        public class ProcessCollection : object, ICollection
        {
            ...
            public virtual void CopyTo(System.Array array, int index)
            {
                ...
                {
                    array.SetValue(new ProcessProxy(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class ProcessEnumerator : object, System.Collections.IEnumerator
            {
                ...
                public virtual object Current
                {
                    get
                    {
                        return new ProcessProxy(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
