...
namespace mk.libWmiNet.Proxy.Registry
{
    // This class was autogenerated using the following command:
    //   MgmtClassGen.exe  StdRegProv  /L CS  /O Wmi.CIMv2.CIM  /N root\Default  /P StdRegProvProxy.cs
    //
    ...
    //
    public class StdRegProvProxy : System.ComponentModel.Component
    {
        ...
        public StdRegProvProxy()
        {
            this.InitializeObject(null, null, null);
        }

        public StdRegProvProxy(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(null, path, getOptions);
        }

        public StdRegProvProxy(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path)
        {
            this.InitializeObject(mgmtScope, path, null);
        }

        public StdRegProvProxy(System.Management.ManagementPath path)
        {
            this.InitializeObject(null, path, null);
        }

        public StdRegProvProxy(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(mgmtScope, path, getOptions);
        }

        public StdRegProvProxy(System.Management.ManagementObject theObject)
        {
            Initialize();
        ...
        public StdRegProvProxy(System.Management.ManagementBaseObject theObject)
        {
            Initialize();
            if ((CheckIfProperClass(theObject) == true))
            {
        ...
        [Browsable(true)]
        public static StdRegProvProxy CreateInstance()
        {
            ...
            return new StdRegProvProxy(tmpMgmtClass.CreateInstance());
        }
        ...
        public class StdRegProvCollection : object, ICollection
        {
            ...
            public virtual void CopyTo(System.Array array, int index)
            {
                ...
                {
                    array.SetValue(new StdRegProvProxy(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class StdRegProvEnumerator : object, System.Collections.IEnumerator
            {
                ...
                public virtual object Current
                {
                    get
                    {
                        return new StdRegProvProxy(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
