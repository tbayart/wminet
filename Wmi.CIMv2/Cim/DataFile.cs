...
namespace Wmi.CIMv2.CIM
{
    // This class was autogenerated using the following command:
    //   MgmtClassGen.exe  CIM_DataFile  /L CS  /O Wmi.CIMv2.CIM  /N root\cimv2  /P DataFile.cs
    //
    ...
    public class DataFile : System.ComponentModel.Component
    {
        ...
        public DataFile(string keyName)
        {
            this.InitializeObject(null, new System.Management.ManagementPath(DataFile.ConstructPath(keyName)), null);
        }

        public DataFile(System.Management.ManagementScope mgmtScope, string keyName)
        {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(DataFile.ConstructPath(keyName)), null);
        }

        public DataFile(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(null, path, getOptions);
        }

        public DataFile(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path)
        {
            this.InitializeObject(mgmtScope, path, null);
        }

        public DataFile(System.Management.ManagementPath path)
        {
            this.InitializeObject(null, path, null);
        }

        public DataFile(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(mgmtScope, path, getOptions);
        }

        public DataFile(System.Management.ManagementObject theObject)
        {
            Initialize();
        ...
        public DataFile(System.Management.ManagementBaseObject theObject)
        {
            Initialize();
            if ((CheckIfProperClass(theObject) == true))
            {
        ...
        [Browsable(true)]
        public static DataFile CreateInstance()
        {
            ...
            return new DataFile(tmpMgmtClass.CreateInstance());
        }
        ...
        public class DataFileCollection : object, ICollection
        {
            ...
            public virtual void CopyTo(System.Array array, int index)
            {
                ...
                {
                    array.SetValue(new DataFile(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class DataFileEnumerator : object, System.Collections.IEnumerator
            {
                ...
                public virtual object Current
                {
                    get
                    {
                        return new DataFile(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
