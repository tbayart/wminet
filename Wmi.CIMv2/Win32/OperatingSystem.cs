...
namespace Wmi.CIMv2.Win32
{
    ...
    //   MgmtClassGen.exe  Win32_OperatingSystem  /L CS  /O Wmi.CIMv2.Win32  /N root\cimv2  /P OperatingSystem.cs
    //
    ...
    //
    public class OperatingSystemWmi : System.ComponentModel.Component
    {
        ...
        public OperatingSystemWmi()
        {
            this.InitializeObject(null, new System.Management.ManagementPath(OperatingSystemWmi.ConstructPath()), null);
        }

        public OperatingSystemWmi(System.Management.ManagementScope mgmtScope)
        {
            this.InitializeObject(mgmtScope, new System.Management.ManagementPath(OperatingSystemWmi.ConstructPath()), null);
        }

        public OperatingSystemWmi(System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(null, new System.Management.ManagementPath(OperatingSystemWmi.ConstructPath()), getOptions);
        }

        public OperatingSystemWmi(System.Management.ManagementScope mgmtScope, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(mgmtScope, new System.Management.ManagementPath(OperatingSystemWmi.ConstructPath()), getOptions);
        }

        public OperatingSystemWmi(System.Management.ManagementPath path)
        {
            this.InitializeObject(null, path, null);
        }

        public OperatingSystemWmi(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(mgmtScope, path, getOptions);
        }

        public OperatingSystemWmi(System.Management.ManagementObject theObject)
        {
            Initialize();
        ...
        public OperatingSystemWmi(System.Management.ManagementBaseObject theObject)
        {
            Initialize();
            if ((CheckIfProperClass(theObject) == true))
            {
...
10 - Windows Server 2003, Web Edition")]
        ...
        [Browsable(true)]
        public static OperatingSystemWmi CreateInstance()
        {
            ...
            return new OperatingSystemWmi(tmpMgmtClass.CreateInstance());
        }
        ...
        public uint Win32ShutdownTracker(string Comment, int Flags, uint ReasonCode, uint Timeout)
        {
            if ((isEmbedded == false))
            {
                ...
                inParams["Comment"] = ((System.String)(Comment));
                inParams["Flags"] = ((System.Int32)(Flags));
                inParams["ReasonCode"] = ((System.UInt32)(ReasonCode));
                inParams["Timeout"] = ((System.UInt32)(Timeout));
